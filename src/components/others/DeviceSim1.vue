...
export default {
  install(Vue, options) {
    Vue.component('device-sim-1-pcon', component)
  },
  name: 'device-sim-1',
  props: {
    size: {
...
<path d="M10 11L12 9V17" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
