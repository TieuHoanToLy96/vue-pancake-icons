...
export default {
  install(Vue, options) {
    Vue.component('xbox-x-pcon', this)
  },
  name: 'xbox-x',
  props: {
    size: {
...
<path d="M9 8L15 16" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M15 8L9 16" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
