...
export default {
  install(Vue, options) {
    Vue.component('login-svg-pcon', component)
  },
  name: 'login-svg',
  props: {
    size: {
...
<path d="M20 12H7L10 9M10 15L7 12" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
