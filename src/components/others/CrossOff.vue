...
export default {
  install(Vue, options) {
    Vue.component('cross-off-pcon', this)
  },
  name: 'cross-off',
  props: {
    size: {
...
<path d="M16 12H19V8H14V3H10V6M8 8H5V12H10V21H14V14" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
