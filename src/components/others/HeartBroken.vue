...
export default {
  install(Vue, options) {
    Vue.component('heart-broken-pcon', this)
  },
  name: 'heart-broken',
  props: {
    size: {
...
<path d="M12 6L10 10L14 13L12 17V20" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
