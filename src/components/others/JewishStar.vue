...
export default {
  install(Vue, options) {
    Vue.component('jewish-star-pcon', this)
  },
  name: 'jewish-star',
  props: {
    size: {
...
<path d="M9.748 5.753L12 2L15 7H21L18 12L21 17M17 17H15L12 22L9 17H3L6 12L3 7H7" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
