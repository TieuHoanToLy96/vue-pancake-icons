...
export default {
  install(Vue, options) {
    Vue.component('device-mobile-message-pcon', this)
  },
...
<path d="M11 3H21V11H18L14 13V11H11V3Z" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
