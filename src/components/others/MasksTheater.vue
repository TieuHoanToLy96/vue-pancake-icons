...
export default {
  install(Vue, options) {
    Vue.component('masks-theater-pcon', component)
  },
  name: 'masks-theater',
  props: {
    size: {
...
<path d="M15 16.5C16 17.167 17 17.167 18 16.5" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M8.6318 15.982C8.50482 15.994 8.37734 16 8.2498 16H6.7498C5.75217 15.9999 4.79058 15.6271 4.0537 14.9546C3.31682 14.2821 2.85783 13.3585 2.7668 12.365L2.1998 6.183C2.17435 5.90606 2.20694 5.62686 2.29548 5.36323C2.38403 5.09959 2.52658 4.85733 2.71404 4.65189C2.9015 4.44646 3.12974 4.28238 3.38418 4.17014C3.63863 4.05789 3.91369 3.99995 4.1918 4H10.8078C11.3382 4 11.8469 4.21071 12.222 4.58579C12.5971 4.96086 12.8078 5.46957 12.8078 6" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M6 8H6.01" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M9 8H9.01" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
