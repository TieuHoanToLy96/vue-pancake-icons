...
export default {
  install(Vue, options) {
    Vue.component('ship-off-pcon', this)
  },
  name: 'ship-off',
  props: {
    size: {
...
<path d="M4 18L3 13H13M17 13H21L19.666 15.668" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M5 13V7H7M11 7H13L17 13" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
