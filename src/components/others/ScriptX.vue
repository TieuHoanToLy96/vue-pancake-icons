...
export default {
  install(Vue, options) {
    Vue.component('script-x-pcon', component)
  },
  name: 'script-x',
  props: {
    size: {
...
<path d="M17 17L21 21M21 17L17 21" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
