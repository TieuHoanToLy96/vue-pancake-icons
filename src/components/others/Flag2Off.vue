...
export default {
  install(Vue, options) {
    Vue.component('flag-2-off-pcon', component)
  },
  name: 'flag-2-off',
  props: {
    size: {
...
<path d="M5 14H14M18 14H19V5H9M5 5V21" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
