...
export default {
  install(Vue, options) {
    Vue.component('wash-dry-shade-pcon', this)
  },
  name: 'wash-dry-shade',
  props: {
    size: {
...
<path d="M3 11L11 3" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M3 17L17 3" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
