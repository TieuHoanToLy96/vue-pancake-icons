...
export default {
  install(Vue, options) {
    Vue.component('brand-messenger-pcon', component)
  },
...
<path d="M8 13L11 11L13 13L16 11" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
