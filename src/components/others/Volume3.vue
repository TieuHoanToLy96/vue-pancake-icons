...
export default {
  install(Vue, options) {
    Vue.component('volume-3-pcon', this)
  },
  name: 'volume-3',
  props: {
    size: {
...
<path d="M16 10L20 14M20 10L16 14" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
