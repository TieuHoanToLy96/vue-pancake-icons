...
export default {
  install(Vue, options) {
    Vue.component('mail-off-pcon', component)
  },
  name: 'mail-off',
  props: {
    size: {
...
<path d="M3 7L12 13L12.598 12.601M15 11L21 7" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
