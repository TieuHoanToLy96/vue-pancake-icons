...
export default {
  install(Vue, options) {
    Vue.component('mood-look-right-pcon', this)
  },
...
<path d="M15 9H14.99" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M20 15H16" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
