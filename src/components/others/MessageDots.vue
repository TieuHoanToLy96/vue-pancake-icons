...
export default {
  install(Vue, options) {
    Vue.component('message-dots-pcon', this)
  },
  name: 'message-dots',
  props: {
    size: {
...
<path d="M8 11V11.01" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M16 11V11.01" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
