...
export default {
  install(Vue, options) {
    Vue.component('license-svg-pcon', this)
  },
  name: 'license-svg',
  props: {
    size: {
...
<path d="M9 7H13" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M9 11H13" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
