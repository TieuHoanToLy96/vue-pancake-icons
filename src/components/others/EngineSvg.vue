...
export default {
  install(Vue, options) {
    Vue.component('engine-svg-pcon', this)
  },
  name: 'engine-svg',
  props: {
    size: {
...
<path d="M3 10V16" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
