...
export default {
  install(Vue, options) {
    Vue.component('message-2-code-pcon', component)
  },
  name: 'message-2-code',
  props: {
    size: {
...
<path d="M10 9L8 11L10 13" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M14 9L16 11L14 13" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
