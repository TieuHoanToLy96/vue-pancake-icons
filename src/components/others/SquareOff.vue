...
export default {
  install(Vue, options) {
    Vue.component('square-off-pcon', this)
  },
  name: 'square-off',
  props: {
    size: {
...
<path d="M8 4H18C18.5304 4 19.0391 4.21071 19.4142 4.58579C19.7893 4.96086 20 5.46957 20 6V16M19.416 19.412C19.2305 19.5986 19.0098 19.7466 18.7668 19.8475C18.5237 19.9485 18.2631 20.0003 18 20H6C5.46957 20 4.96086 19.7893 4.58579 19.4142C4.21071 19.0391 4 18.5304 4 18V6C4 5.448 4.224 4.948 4.586 4.586" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
