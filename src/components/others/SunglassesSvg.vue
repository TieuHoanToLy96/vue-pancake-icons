...
export default {
  install(Vue, options) {
    Vue.component('sunglasses-svg-pcon', this)
  },
  name: 'sunglasses-svg',
  props: {
    size: {
...
<path d="M4 14L8.5 18.5" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M15 14L19.5 18.5" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
