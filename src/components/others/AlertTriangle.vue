...
export default {
  install(Vue, options) {
    Vue.component('alert-triangle-pcon', component)
  },
  name: 'alert-triangle',
  props: {
    size: {
...
<path d="M12 9V11M12 15V15.01" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
