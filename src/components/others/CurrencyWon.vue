...
export default {
  install(Vue, options) {
    Vue.component('currency-won-pcon', component)
  },
  name: 'currency-won',
  props: {
    size: {
...
<path d="M21 10H3" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M21 14H3" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
