...
export default {
  install(Vue, options) {
    Vue.component('parking-off-pcon', this)
  },
  name: 'parking-off',
  props: {
    size: {
...
<path d="M9 16V9M12 8H13C13.3354 7.99998 13.6655 8.08433 13.9598 8.24529C14.2541 8.40624 14.5032 8.63863 14.6841 8.92107C14.8651 9.20351 14.9721 9.52692 14.9953 9.86155C15.0185 10.1962 14.9572 10.5313 14.817 10.836M12 12H9" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
