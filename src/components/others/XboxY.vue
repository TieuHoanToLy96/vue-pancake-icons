...
export default {
  install(Vue, options) {
    Vue.component('xbox-y-pcon', component)
  },
  name: 'xbox-y',
  props: {
    size: {
...
<path d="M9 8L12 12" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M15 8L12.012 11.984L12 16" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
