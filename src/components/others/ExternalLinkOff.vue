...
export default {
  install(Vue, options) {
    Vue.component('external-link-off-pcon', this)
  },
...
<path d="M10 14L11.996 12.004M14.003 9.997L20 4" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M15 4H20V9" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
