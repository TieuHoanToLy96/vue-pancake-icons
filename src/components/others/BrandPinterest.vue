...
export default {
  install(Vue, options) {
    Vue.component('brand-pinterest-pcon', component)
  },
...
<path d="M8 20L12 11" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
