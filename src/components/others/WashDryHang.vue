...
export default {
  install(Vue, options) {
    Vue.component('wash-dry-hang-pcon', component)
  },
  name: 'wash-dry-hang',
  props: {
    size: {
...
<path d="M4 4.01C9.333 9.333 14.667 9.33 20 4" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
