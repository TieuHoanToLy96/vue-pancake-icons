...
export default {
  install(Vue, options) {
    Vue.component('circle-caret-left-pcon', component)
  },
...
<path d="M9 12L13 8V16L9 12Z" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
