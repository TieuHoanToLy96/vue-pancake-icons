...
export default {
  install(Vue, options) {
    Vue.component('elements-svg-pcon', component)
  },
  name: 'elements-svg',
  props: {
    size: {
...
<path d="M7.3575 9.97785C7.3575 9.97785 3.5 7.75762 3.5 5.06164C3.50008 4.58514 3.66072 4.12337 3.95462 3.75485C4.24852 3.38632 4.65754 3.13379 5.11212 3.04018C5.56671 2.94657 6.03881 3.01767 6.44816 3.24139C6.8575 3.4651 7.17883 3.82762 7.35751 4.26731L7.3575 4.26732C7.53617 3.82762 7.8575 3.4651 8.26685 3.24139C8.67619 3.01767 9.14829 2.94658 9.60288 3.04018C10.0575 3.13379 10.4665 3.38632 10.7604 3.75485C11.0543 4.12337 11.2149 4.58514 11.215 5.06164C11.215 7.75762 7.3575 9.97785 7.3575 9.97785Z" stroke="currentColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
